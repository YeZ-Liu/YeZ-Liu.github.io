...
**1.** 获取处理翻译信息的网页（这里采用的是谷歌浏览器）  
  打开有道翻译网页 进入开发者模式  
  选择Network
  ![Youdao1](https://raw.githubusercontent.com/Joke-Lin/Joke-Lin.github.io/master/assets/ArticleImg/Youdao/Youdao1.png)  
  然后在左边的输入框随便输入一个单词 会发现多了很多文件
  ![Youdao2](https://raw.githubusercontent.com/Joke-Lin/Joke-Lin.github.io/master/assets/ArticleImg/Youdao/Youdao2.png)
...
**2.** 发送信息包 如下
  ![Youdao3](https://raw.githubusercontent.com/Joke-Lin/Joke-Lin.github.io/master/assets/ArticleImg/Youdao/Youdao3.png)
...
**3.** 获取反馈并处理  
  ![Youdao4](https://raw.githubusercontent.com/Joke-Lin/Joke-Lin.github.io/master/assets/ArticleImg/Youdao/Youdao4.png)
