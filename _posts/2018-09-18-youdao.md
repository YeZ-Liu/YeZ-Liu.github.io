...
**1.** 获取处理翻译信息的网页（这里采用的是谷歌浏览器）  
  打开有道翻译网页 进入开发者模式  
  选择Network
  ![Youdao1](https://github.com/Joke-Lin/Joke-Lin.github.io/tree/master/assets/ArticleImg/Youdao/Youdao1.png?raw=true)  
  然后在左边的输入框随便输入一个单词 会发现多了很多文件
  ![Youdao2](https://github.com/Joke-Lin/Joke-Lin.github.io/tree/master/assets/ArticleImg/Youdao/Youdao1.png?raw=true)
...
**2.** 发送信息包 如下
  ![Youdao3](https://github.com/Joke-Lin/Joke-Lin.github.io/tree/master/assets/ArticleImg/Youdao/Youdao1.png?raw=true)
...
**3.** 获取反馈并处理  
  ![Youdao4](https://github.com/Joke-Lin/Joke-Lin.github.io/tree/master/assets/ArticleImg/Youdao/Youdao1.png?raw=true)
